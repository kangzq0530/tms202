...
public class NetworkConfig {
    ...
    @ConfigComments(
            comment = {"Host for channel server binding.", "Default: 0.0.0.0"}
    )
    @ConfigProperty(
            name = "network.channel.host",
            value = "0.0.0.0"
    )
    public static String HOST;
    @ConfigComments(
            comment = {"The base port number for channel server binding.", "Default: 8585"}
    )
    @ConfigProperty(
            name = "network.channel.port",
            value = "8585"
    )
