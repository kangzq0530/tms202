...
public class QuestData {
    ...
    public static void loadQuestsFromWZ() {
        String wzDir = CoreConfig.WZ_PATH + "/Quest.wz/";
                ...
                for (Node infoNode : XMLApi.getAllChildren(statusNode)) {
                    ...
                    switch (name) {
                        ...
                        case "charismaMin":
                            ...
                            break;
                        case "insightMin":
                            quest.addRequirement(new QuestStartMinStatRequirement(Stat.ICE_GAGE, Short.parseShort(value)));
                            break;
                        case "willMin":
                                ...
                                for (Node questNode : XMLApi.getAllChildren(idNode)) {
                                    ...
                                    switch (questName) {
                                        ...
                                        case "levelCondition":
                                            break;
                                        default:
                                            log.warn(String.format("(%d) Unk skills name %s with value %s", questID, questName, questValue));
                                            break;
                                    }
                                }
                            }
    ...
    public static void generateDatFiles() {
        ...
        saveAllQuestInfos(CoreConfig.DAT_PATH + "\\quests");
    }
    ...
    private static void saveAllQuestInfos(String dir) {
        ...
        for (QuestInfo qi : getBaseQuests()) {
            ...
            try (DataOutputStream dos = new DataOutputStream(new FileOutputStream(file))) {
                ...
                for (IQuestStartRequirement qsr : qi.getQuestStartRequirements()) {
                ...
                for (IQuestReward qr : qi.getQuestRewards()) {
    ...
    private static QuestInfo loadQuestInfoById(int id) {
        File file = new File(String.format("%s\\quests\\%d.dat", CoreConfig.DAT_PATH, id));
    ...
    public static Quest createQuestFromId(int questID) {
        ...
        qi.getQuestProgressRequirements().forEach(quest::addQuestProgressRequirement);
        return quest;
    }
