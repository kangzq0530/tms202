...
import com.msemu.world.network.packets.WvsContext.TemporaryStatReset;
import com.msemu.world.network.packets.WvsContext.TemporaryStateSet;
...
import static com.msemu.world.client.character.skills.CharacterTemporaryStat.Thread;
...
public class TemporaryStatManager {
    ...
    public void encodeForLocal(OutPacket outPacket) {
        ...
        if (hasNewStat(IDA_BUFF_78)) {
            outPacket.encodeShort(getOption(IDA_BUFF_78).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_78).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_78).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_80)) {
            outPacket.encodeShort(getOption(IDA_BUFF_80).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_80).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_80).tOption);
        }
        if (hasNewStat(IDA_BUFF_79)) {
            outPacket.encodeShort(getOption(IDA_BUFF_79).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_79).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_79).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_249)) {
            outPacket.encodeShort(getOption(IDA_BUFF_249).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_249).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_249).tOption);
        }
        if (hasNewStat(IDA_BUFF_250)) {
            outPacket.encodeShort(getOption(IDA_BUFF_250).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_250).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_250).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_107)) {
            outPacket.encodeShort(getOption(IDA_BUFF_107).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_107).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_107).tOption);
        }
        if (hasNewStat(IDA_BUFF_108)) {
            outPacket.encodeShort(getOption(IDA_BUFF_108).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_108).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_108).tOption);
        }
...
//        }
        ...
        if (hasNewStat(IDA_BUFF_284)) {
            outPacket.encodeShort(getOption(IDA_BUFF_284).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_284).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_284).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_296)) {
            outPacket.encodeShort(getOption(IDA_BUFF_296).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_296).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_296).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_413)) {
            outPacket.encodeShort(getOption(IDA_BUFF_413).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_413).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_413).tOption);
        }
        ...
        if (hasNewStat(AnimalChange)) {
            outPacket.encodeShort(getOption(AnimalChange).nOption);
            outPacket.encodeInt(getOption(AnimalChange).rOption);
            outPacket.encodeInt(getOption(AnimalChange).tOption);
        }
        if (hasNewStat(IDA_BUFF_436)) {
            outPacket.encodeShort(getOption(IDA_BUFF_436).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_436).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_436).tOption);
        }
        if (hasNewStat(IDA_BUFF_437)) {
            outPacket.encodeShort(getOption(IDA_BUFF_437).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_437).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_437).tOption);
        }
        if (hasNewStat(IDA_BUFF_433)) {
            outPacket.encodeShort(getOption(IDA_BUFF_433).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_433).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_433).tOption);
        }

        if (hasNewStat(IncMaxDamage)) {
            outPacket.encodeShort(getOption(IncMaxDamage).nOption);
            outPacket.encodeInt(getOption(IncMaxDamage).rOption);
            outPacket.encodeInt(getOption(IncMaxDamage).tOption);
        }
        if (hasNewStat(IDA_BUFF_434)) {
            outPacket.encodeShort(getOption(IDA_BUFF_434).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_434).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_434).tOption);
        }
        if (hasNewStat(IDA_BUFF_431)) {
            outPacket.encodeShort(getOption(IDA_BUFF_431).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_431).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_431).tOption);
        }
        ...
        if (hasNewStat(AURA_BOOST)) {
            outPacket.encodeShort(getOption(AURA_BOOST).nOption);
            outPacket.encodeInt(getOption(AURA_BOOST).rOption);
            outPacket.encodeInt(getOption(AURA_BOOST).tOption);
        }
        ...
        if (hasNewStat(Shikigami)) {
            outPacket.encodeShort(getOption(Shikigami).nOption);
            outPacket.encodeInt(getOption(Shikigami).rOption);
            outPacket.encodeInt(getOption(Shikigami).tOption);
        }
        ...
        if (hasNewStat(PLAYERS_BUFF430)) {
            outPacket.encodeShort(getOption(PLAYERS_BUFF430).nOption);
            outPacket.encodeInt(getOption(PLAYERS_BUFF430).rOption);
            outPacket.encodeInt(getOption(PLAYERS_BUFF430).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_439)) {
            outPacket.encodeShort(getOption(IDA_BUFF_439).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_439).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_439).tOption);
        }
        if (hasNewStat(IDA_BUFF_155)) {
            outPacket.encodeShort(getOption(IDA_BUFF_155).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_155).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_155).tOption);
        }
        if (hasNewStat(IDA_BUFF_524)) {
            outPacket.encodeShort(getOption(IDA_BUFF_524).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_524).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_524).tOption);
        }
        if (hasNewStat(IDA_BUFF_526)) {
            outPacket.encodeShort(getOption(IDA_BUFF_526).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_526).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_526).tOption);
        }
        if (hasNewStat(IDA_BUFF_527)) {
            outPacket.encodeShort(getOption(IDA_BUFF_527).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_527).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_527).tOption);
        }
        if (hasNewStat(IDA_BUFF_528)) {
            outPacket.encodeShort(getOption(IDA_BUFF_528).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_528).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_528).tOption);
        }
        if (hasNewStat(IDA_BUFF_529)) {
            outPacket.encodeShort(getOption(IDA_BUFF_529).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_529).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_529).tOption);
        }
        if (hasNewStat(IDA_BUFF_530)) {
            outPacket.encodeShort(getOption(IDA_BUFF_530).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_530).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_530).tOption);
        }
        if (hasNewStat(IDA_BUFF_531)) {
            outPacket.encodeShort(getOption(IDA_BUFF_531).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_531).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_531).tOption);
        }
        if (hasNewStat(IDA_BUFF_532)) {
            outPacket.encodeShort(getOption(IDA_BUFF_532).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_532).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_532).tOption);
        }
        if (hasNewStat(IDA_BUFF_533)) {
            outPacket.encodeShort(getOption(IDA_BUFF_533).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_533).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_533).tOption);
        }
        ...
        if (hasNewStat(IDA_BUFF_495)) {
            outPacket.encodeShort(getOption(IDA_BUFF_495).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_495).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_495).tOption);
        }


        if (hasNewStat(IDA_BUFF_496)) {
            outPacket.encodeShort(getOption(IDA_BUFF_496).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_496).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_496).tOption);
        }


        if (hasNewStat(IDA_BUFF_488)) {
            outPacket.encodeShort(getOption(IDA_BUFF_488).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_488).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_488).tOption);
        }

        if (hasNewStat(IDA_BUFF_489)) {
            outPacket.encodeShort(getOption(IDA_BUFF_489).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_489).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_489).tOption);
        }

        if (hasNewStat(IDA_BUFF_491)) {
            outPacket.encodeShort(getOption(IDA_BUFF_491).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_491).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_491).tOption);
        }

        if (hasNewStat(元氣覺醒)) {
            outPacket.encodeShort(getOption(元氣覺醒).nOption);
            outPacket.encodeInt(getOption(元氣覺醒).rOption);
            outPacket.encodeInt(getOption(元氣覺醒).tOption);
        }

        if (hasNewStat(能量爆炸)) {
            outPacket.encodeShort(getOption(能量爆炸).nOption);
            outPacket.encodeInt(getOption(能量爆炸).rOption);
            outPacket.encodeInt(getOption(能量爆炸).tOption);
        }

        if (hasNewStat(IDA_BUFF_504)) {
            outPacket.encodeShort(getOption(IDA_BUFF_504).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_504).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_504).tOption);
        }

        if (hasNewStat(IDA_BUFF_505)) {
            outPacket.encodeShort(getOption(IDA_BUFF_505).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_505).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_505).tOption);
        }

        if (hasNewStat(IDA_BUFF_506)) {
            outPacket.encodeShort(getOption(IDA_BUFF_506).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_506).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_506).tOption);
        }

        if (hasNewStat(交換攻擊)) {
            outPacket.encodeShort(getOption(交換攻擊).nOption);
            outPacket.encodeInt(getOption(交換攻擊).rOption);
            outPacket.encodeInt(getOption(交換攻擊).tOption);
        }

        if (hasNewStat(聖靈祈禱)) {
            outPacket.encodeShort(getOption(聖靈祈禱).nOption);
            outPacket.encodeInt(getOption(聖靈祈禱).rOption);
            outPacket.encodeInt(getOption(聖靈祈禱).tOption);
        }

        if (hasNewStat(IDA_BUFF_509)) {
            outPacket.encodeShort(getOption(IDA_BUFF_509).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_509).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_509).tOption);
        }

        if (hasNewStat(IDA_BUFF_510)) {
            outPacket.encodeShort(getOption(IDA_BUFF_510).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_510).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_510).tOption);
        }

        if (hasNewStat(IDA_BUFF_412)) {
            outPacket.encodeShort(getOption(IDA_BUFF_412).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_412).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_412).tOption);
        }

        if (hasNewStat(IDA_BUFF_511)) {
            outPacket.encodeShort(getOption(IDA_BUFF_511).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_511).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_511).tOption);
        }

        if (hasNewStat(散式投擲)) {
            outPacket.encodeShort(getOption(散式投擲).nOption);
            outPacket.encodeInt(getOption(散式投擲).rOption);
            outPacket.encodeInt(getOption(散式投擲).tOption);
        }

        if (hasNewStat(IDA_BUFF_513)) {
            outPacket.encodeShort(getOption(IDA_BUFF_513).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_513).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_513).tOption);
        }

        if (hasNewStat(IDA_BUFF_514)) {
            outPacket.encodeShort(getOption(IDA_BUFF_514).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_514).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_514).tOption);
        }

        if (hasNewStat(滅殺刃影)) {
            outPacket.encodeShort(getOption(滅殺刃影).nOption);
            outPacket.encodeInt(getOption(滅殺刃影).rOption);
            outPacket.encodeInt(getOption(滅殺刃影).tOption);
        }

        if (hasNewStat(IDA_BUFF_517)) {
            outPacket.encodeShort(getOption(IDA_BUFF_517).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_517).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_517).tOption);
        }

        if (hasNewStat(惡魔狂亂)) {
            outPacket.encodeShort(getOption(惡魔狂亂).nOption);
            outPacket.encodeInt(getOption(惡魔狂亂).rOption);
            outPacket.encodeInt(getOption(惡魔狂亂).tOption);
        }

        if (hasNewStat(IDA_BUFF_519)) {
            outPacket.encodeShort(getOption(IDA_BUFF_519).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_519).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_519).tOption);
        }

        if (hasNewStat(IDA_BUFF_520)) {
            outPacket.encodeShort(getOption(IDA_BUFF_520).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_520).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_520).tOption);
        }
        if (hasNewStat(IDA_BUFF_521)) {
            outPacket.encodeShort(getOption(IDA_BUFF_521).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_521).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_521).tOption);
        }
        if (hasNewStat(IDA_BUFF_534)) {
            outPacket.encodeShort(getOption(IDA_BUFF_534).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_534).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_534).tOption);
        }
        if (hasNewStat(IDA_BUFF_535)) {
            outPacket.encodeShort(getOption(IDA_BUFF_535).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_535).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_535).tOption);
        }
        if (hasNewStat(IDA_BUFF_536)) {
            outPacket.encodeShort(getOption(IDA_BUFF_536).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_536).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_536).tOption);
        }
        if (hasNewStat(IDA_BUFF_537)) {
            outPacket.encodeShort(getOption(IDA_BUFF_537).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_537).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_537).tOption);
        }
        if (hasNewStat(IDA_BUFF_441)) {
            outPacket.encodeShort(getOption(IDA_BUFF_441).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_441).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_441).tOption);
        }
        if (hasNewStat(IDA_BUFF_442)) {
            outPacket.encodeShort(getOption(IDA_BUFF_442).nOption);
            outPacket.encodeInt(getOption(IDA_BUFF_442).rOption);
            outPacket.encodeInt(getOption(IDA_BUFF_442).tOption);
        }
        ...
        if (hasNewStat(KeyDownMoving)) {
            outPacket.encodeByte(getOption(KeyDownMoving).nOption);
        }
        ...
        if (hasNewStat(DebuffTolerance)) {
            outPacket.encodeInt(getOption(DebuffTolerance).xOption);
        }
        if (hasNewStat(DotHealHPPerSecond)) {
            outPacket.encodeInt(getOption(DotHealHPPerSecond).xOption);
        }
        if (hasNewStat(DotHealMPPerSecond)) {
            outPacket.encodeInt(getOption(DotHealMPPerSecond).xOption);
        }
        if (hasNewStat(SpiritGuard)) {
        ...
        if (hasNewStat(IDA_BUFF_505)) {
            outPacket.encodeInt(getOption(IDA_BUFF_505).bOption);
        }
        if (hasNewStat(IDA_BUFF_250)) {
            outPacket.encodeInt(getOption(IDA_BUFF_250).bOption);
        }
        if (hasNewStat(CriticalGrowing)) {
            outPacket.encodeInt(getOption(CriticalGrowing).bOption);
        }
        if (hasNewStat(Ember)) {
            outPacket.encodeInt(getOption(Ember).bOption);
        }
        if (hasNewStat(PickPocket)) {
            outPacket.encodeInt(getOption(PickPocket).bOption);
        }

        if (hasNewStat(IDA_BUFF_412)) {
            outPacket.encodeShort(getOption(IDA_BUFF_412).bOption);
        }
        if (hasNewStat(IDA_BUFF_413)) {
            outPacket.encodeShort(getOption(IDA_BUFF_413).bOption);
        }
        if (hasNewStat(IDA_BUFF_414)) {
            outPacket.encodeShort(getOption(IDA_BUFF_414).bOption);
        }
        if (hasNewStat(IDA_BUFF_523)) {
            outPacket.encodeInt(getOption(IDA_BUFF_523).bOption);
            outPacket.encodeInt(0);
            outPacket.encodeInt(0);
            outPacket.encodeInt(0);
        }
        ...
        if (hasNewStat(VampDeath)) {
            outPacket.encodeInt(getOption(VampDeath).bOption);
        }
...
//        }
        ...
        if (hasNewStat(RideVehicleExpire)) {
            outPacket.encodeByte(1);
            outPacket.encodeByte(1);
        }

        if (hasNewStat(COUNT_PLUS1)) {
            outPacket.encodeByte(0);
            outPacket.encodeByte(1);
        }

        if (hasNewStat(IDA_BUFF_525)) {
            outPacket.encodeByte(1);
        }
