...
public class DropData {
    ...
    public static void loadDropsFromWz() {
        String wzDir = CoreConfig.WZ_PATH + "/String.wz/MonsterBook.img.xml";
    ...
    public static Set<DropInfo> getDropInfoByID(int mobID) {
        ...
        if (drops == null) {
            File file = new File(String.format("%s/mobDrops/%d.dat", CoreConfig.DAT_PATH, mobID));
            if (file.exists()) {
    ...
    public static void generateTxtFromMonsterBook() {
        loadDropsFromWz();
        saveDropsToTxt(new File("./mobDrops.txt"));
    }

    public static void generateDatFiles() {
        loadCompleteDropsFromTxt(new File("./mobDrops.txt"));
        saveDropsToDat(CoreConfig.DAT_PATH + "/mobDrops");
    }
