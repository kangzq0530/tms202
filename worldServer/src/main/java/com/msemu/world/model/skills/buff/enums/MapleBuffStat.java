...
public enum MapleBuffStat implements Serializable, IBuffStat {
    ...
    NoDebuff(401),
    // 更新BUFF用                   []
    BattlePvP_Mike_Shield(402),
    // 更新BUFF用                   []
    BattlePvP_Mike_Bugle(403),
    //神盾系統                      []
    ...
    //能量獲得                           [202]
    BattlePvP_Helena_Mark(443),
    // 更新BUFF用                     [猜測]
    BattlePvP_Helena_WindSpirit(444),
    //預設Buff-3                       [猜測]
    BattlePvP_LangE_Protection(445),
    // 更新BUFF用                     [猜測]
    BattlePvP_LeeMalNyun_ScaleUp(446),
    // 更新BUFF用                       [猜測]
    BattlePvP_Revive(447),
    //皮卡啾攻擊                      [猜測]
