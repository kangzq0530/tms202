...
public class ItemTemplate {
    ...
    @Getter
    @Setter
    private Map<ItemScrollStat, Integer> scrollStats = new HashMap<>();
    @Getter
    @Setter
    private Map<ItemSpecStat, Integer> specStats = new HashMap<>();
    @Getter
    @Setter
    private int bagType;
    @Getter
    ...
    private int flatRate, limitMin, limitLess, sharedStatCostGrade, levelVariation, maxDays
            ...
            , mesomin, mesomax, mesostdev, floatType, type, direction
