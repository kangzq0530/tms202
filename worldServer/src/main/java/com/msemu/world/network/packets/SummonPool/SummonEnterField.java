 ...
 */
public class SummonEnterField extends OutPacket {

    public SummonEnterField(int charID, Summon summon) {
        super(OutHeader.SummonedEnterField);
        ...
        encodeByte(summon.getMoveAction());
