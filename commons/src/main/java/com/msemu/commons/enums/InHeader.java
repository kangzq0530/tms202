...
public enum InHeader implements IHeader {
    ...
    CheckSPWExistRequest(ClientState.AUTHED),
    MigrateIn(ClientState.CONNECTED),
    SelectCharacter(ClientState.AUTHED),
    SelectGoToStarPlanet,
    SelectAccount,
    WorldInfoRequest(ClientState.AUTHED),
    CheckDuplicatedID(ClientState.AUTHED),
    CreateNewCharacter(ClientState.AUTHED),
    UpdateCharacterSelectList(ClientState.AUTHED),
    DeleteCharacter(ClientState.AUTHED),
    ...
    ClientDumpLog(ClientState.values()),
    ...
    CheckSPWOnCreateNewCharacter(ClientState.AUTHED),
    GoldHammerRequest,
    GoldHammerComplete,
