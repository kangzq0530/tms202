...
import com.msemu.world.client.character.quest.requirements.QuestProgressRequirement;
...
public class QuestInfo {
    ...
    private Set<IQuestStartRequirement> questStartRequirements = new HashSet<>();
    private Set<QuestProgressRequirement> questProgressRequirements = new HashSet<>();
    private Set<IQuestReward> questRewards = new HashSet<>();
    ...
    public Set<IQuestReward> getQuestRewards() {
        return questRewards;
    }
    ...
    public Set<IQuestStartRequirement> getQuestStartRequirements() {
        return questStartRequirements;
    }

    public void addRequirement(IQuestStartRequirement qr) {
    ...
    public void addReward(IQuestReward qir) {
