 ...
 */
public class MobChangeController extends OutPacket {

    public MobChangeController(Mob mob, boolean hasBeenInit, boolean isController) {
        super(OutHeader.MobChangeController);
        encodeByte(isController);
